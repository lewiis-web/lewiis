	...
	<div id="layout-footer">
		<div class="footer-main">
			...
			<div class="footer-item">
				...
				<div>
					<a target="_self" class="out-link" @click="goBms"
						>☞{{ $t("index.footer.admin") }}</a
					>
				</div>
			</div>
		</div>
...
export default {
	...
	methods: {
		...
		goBms() {
			window.open(`http://admin.lewiis.top/#/login`, "_blank");
		},
	},
	created() {
		this.getSocial();
